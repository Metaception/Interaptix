...
class fully_connected_network:
	# global parameters
	output_classes = 10
	learning_rate = 0.004918208793146879 # should try with 3 different values
	weight_decay_factor = 0.0016751877319401201
	...
	def __init__(self, inputs, targets, dropout):
		...
		self.hidden1_units = 451
		self.hidden2_units = 354
		self.hidden3_units = 318
		self.hidden4_units = 178
		self.forward_prop()
		self.backward_prop()
	# Forward propagation
