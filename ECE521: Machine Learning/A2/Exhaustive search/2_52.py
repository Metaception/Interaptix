...
class fully_connected_network:
	# global parameters
	output_classes = 10
	learning_rate = 0.0028480749611955606 # should try with 3 different values
	weight_decay_factor = 0.001423541106916172
	...
	def __init__(self, inputs, targets, dropout):
		...
		self.hidden1_units = 202
		self.hidden2_units = 434
		self.forward_prop()
		self.backward_prop()
	# Forward propagation
